 ...
 */
package edu.slcc.asdv.Prob5;

import edu.slcc.asdv.Prob5.HealthPlanFinder;
import edu.slcc.asdv.Prob5.HealthPlanLookupMap;
import javax.inject.Named;
import javax.enterprise.context.RequestScoped;
import edu.slcc.asdv.Prob5.HealthPlan;
/**
 *
 * @author Greg
 */
...
public class HPlanBean {
    ...
    private static HealthPlanFinder healthPlanFinder = new HealthPlanLookupMap();
     ...
     private final String[] healthPlanChoices = {"stealallyourmoney", 
         "bloodpoisonslittlehelper", "youdead"};

    public String[] getHealthPlanChoices() {
        return healthPlanChoices;
    }
