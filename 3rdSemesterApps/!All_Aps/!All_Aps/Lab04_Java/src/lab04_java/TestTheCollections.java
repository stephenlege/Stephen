...
public class TestTheCollections {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(list4 + "brown is at index: " + Collections.binarySearch(list4, "amber"));
        ...
        System.out.println("Original lists: " + list6);
        Collections.shuffle(list6, new Random(20));
        System.out.println("Shuffled lists: " + list6);

        System.out.println("Original lists: " + list7);
        Collections.shuffle(list6, new Random(20));
        System.out.println("Shuffled lists: " + list7);
        ...
        System.out.println("The output for list8 is {white, black, green, blue}.\n"
                ...
                + "shallow copy: only the references of the elements from the source"
                + "list are copied");
        ...
        /**
         * The disjoint(collection 1 , collection 2) method returns true if the two collections 
         * have no elements in common.  For example, in the following code.  disjoint
         * returns false, but disjoint (collection 1, col 3) returns true
         * 
         */
            
        System.out.println("\nCollectinos.disjoint()");
        ...
        System.out.println(collection + " red occurs " + Collections.frequency(collection, "red") 
        + " times");
