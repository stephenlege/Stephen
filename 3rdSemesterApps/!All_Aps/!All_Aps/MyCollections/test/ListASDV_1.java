...
public class ListASDV_1<E>
     ...
     */
    public ListASDV_1(Collection<? extends E> c) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    /**
     *
     * @return Iterator with the implementation of: hasNext, next
     * forEachRemaining
     */
    @Override
    ...
    public void add(int index, E element) {
        ...
        if (head == null) { // list is empty
            head = tail = entry;
        } else if (index == 0) { // deals with entry at beginning of list
            entry.right = head;
            head.left = entry;
            head = entry;
        } else if (index == size()) { // deals with entry at end of list
            entry.left = tail;
            tail.right = entry;
            tail = entry;
    ...
    public ListIterator<E> listIterator(int index) {
        ListIterator<E> it = new ListIterator<E>() {
            ...
            Node<E> trailPrevious = trailNext.left;
            ...
            @Override
            public E previous() {
                Node<E> temp = trailNext.left;
                trailPrevious = trailNext;
                trailNext = trailNext.left;
                previousIndex = --nextIndex;
                previousIndex--;
                return temp.e;
            }
    ...
    public List<E> subList(int fromIndex, int toIndex) {
        ...
        int i = 0;
        ListASDV_1<E> list = new ListASDV_1<E>();
    ...
    protected Object clone() throws CloneNotSupportedException {
        ListASDV_1<E> list = (ListASDV_1<E>) super.clone();
        ListASDV_1<E> copy = (ListASDV_1<E>) new ListASDV_1<E>();
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        ListASDV_1<Integer> list = new ListASDV_1<Integer>();
        list.add(100);
        list.addFirst(50);
        list.add(1, 75);
        list.addLast(200);
        ...
        System.out.println("\nclone() ***************************************");
        ListASDV_1<Integer> listCloned = (ListASDV_1<Integer>) list.clone();
        list.clear();
        ...
        list.add(2, -888);
        list.add(-888);
        listCloned = (ListASDV_1) list.clone();
        System.out.println(list);
        ...
        list = (ListASDV_1) listCloned.clone();
        list.retainAll(col);
        System.out.println(list);
