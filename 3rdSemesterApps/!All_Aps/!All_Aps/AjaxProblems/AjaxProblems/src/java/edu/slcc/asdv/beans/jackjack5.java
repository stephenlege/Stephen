...
import edu.slcc.asdv.pojos.Page;
import static edu.slcc.asdv.pojos.Page.DEFEAT;
import static edu.slcc.asdv.pojos.Page.VICTORY;
...
@Named(value = "jackjack5")
@SessionScoped
public class jackjack5 implements Serializable {
