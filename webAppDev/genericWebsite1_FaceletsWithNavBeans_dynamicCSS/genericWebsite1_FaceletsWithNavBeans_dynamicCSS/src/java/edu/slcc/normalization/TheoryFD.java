...
public class TheoryFD
{
                ...
                for (int j = 0; j < xWithoutA.length; ++j)
                  {
                    ...
                    //>> If the closure of X contains ALL characters of LHS of FD
     ...
     */
    private static ArrayList<String> makeRHSsinglenton(ArrayList<String> fds, 
            String token)
    {
...
fds.add("D->A");
        */
        ...
        System.out.println( TheoryFD.closure(fds, "B", "->") );
        /*
        fds.add("AB->C");
        fds.add("C->A");
        fds.add("BC->D"); 
